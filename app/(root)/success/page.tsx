...
const page = () => {
  return (
    <div className=" h-screen flex items-center justify-center">
      <div className="bg-dark-1 p-6  md:mx-auto">
        ...
        <div className="text-center">
            ...
            <p className="text-white/70 my-2">Thank you for completing your secure online payment.</p>
            <p className='text-white/60'> Have a great day!  </p>
